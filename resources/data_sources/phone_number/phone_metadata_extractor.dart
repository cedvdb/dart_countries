...
Future<Map<String, PhoneDescription>> getPhoneDescriptionMap() async {
...
Map<String, PhoneDescription> _toPhoneDescriptions(
  List<XmlElement> territories,
) {
  final result = <String, PhoneDescription>{};
...
PhoneValidationRules _extractPhoneValidationRules(XmlElement element) {
  ...
  final lengths = lengthsUnparsed != null
      ? _parsePossibleLengths(lengthsUnparsed)
      : <int>[];
